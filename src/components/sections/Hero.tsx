    ...
    >
      <div className="w-full px-4 sm:px-6 md:px-10 lg:px-20 xl:px-28 grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-8 pt-10 sm:pt-12 lg:pt-16 pb-0 lg:items-stretch">
        <div className="lg:col-span-6 pb-0 md:pb-12 lg:pb-0 text-center sm:text-left lg:flex lg:flex-col lg:justify-center lg:-translate-y-20">
          ...
          <blockquote className="hidden md:block mt-7 lg:mt-5 border-l-2 border-hero-green/40 pl-4 text-lg sm:text-xl lg:text-lg xl:text-xl italic font-serif text-hero-ink max-w-xl mx-auto sm:mx-0">
            A mente que se desafia a conhecer a si mesma é a que encontra
            equilíbrio e clareza.
          </blockquote>

          <p className="mt-7 lg:mt-5 flex items-center justify-center sm:justify-start gap-2 text-sm md:text-base font-medium text-hero-muted">
            <Leaf className="hidden md:block h-4 w-4 text-hero-green" aria-hidden />
          ...
          <div className="mt-8 lg:mt-6 flex flex-wrap justify-center sm:justify-start gap-3">
            ...
            <Button asChild variant="outline-green" size="lg" className="hidden md:inline-flex">
